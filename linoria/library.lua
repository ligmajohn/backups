--[[
if game:GetService("CoreGui"):FindFirstChild("greenbottomapplejeansbootswiththefurthefur") then
    game:GetService("CoreGui"):FindFirstChild("greenbottomapplejeansbootswiththefurthefur"):Destroy()
end
]]
...
ScreenGui.Name = "greenbottomapplejeansbootswiththefurthefur"
