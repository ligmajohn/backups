...
do
    ...
    function library:New(info)
        ...
        local guibindkey = info.uibind or info.Uibind or info.UiBind or info.UIBind or Enum.KeyCode.Z
        --
        theme.accent = accent
        --
        local window = {pages = {}, isVisible = false, uibind = guibindkey, currentPage = nil, fading = false, dragging = false, drag = Vector2.new(0,0), currentContent = {frame = nil, dropdown = nil, multibox = nil, colorpicker = nil, keybind = nil}}
        --
...
Visible = false
    ...
    --
    function library:UIBindKey(info)
        window.uibind = info or Enum.KeyCode.Z
    end
